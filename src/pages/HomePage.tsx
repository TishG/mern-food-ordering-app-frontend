	...
	return (
		<div className='flex flex-col gap-12'>
			<div className='md:px-32 bg-white rounded-lg shadow-md py-8 flex-col gap-5 text-center -mt-16'>
				...
				<p className='text-xl py-2 text-gray-500'>Food is just a click away!</p>
				<div className='px-5'>
					<SearchBar
			...
			<div className='grid md_grid-cols-2 gap-5'>
				...
				<div className='flex flex-col items-center justify-center gap-4 text-center'>
					...
					<img
						...
						alt='Download our app from the App Store or Google Play'
					/>
				</div>
			</div>
		</div>
